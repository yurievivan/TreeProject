...
public class HibernateUtil {
    ...
    private static final String SQL_QUERIES = "improvedClosureTableQueries.hbm.xml";
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            ...
            configuration.addAnnotatedClass(FileName.class);
            configuration.addAnnotatedClass(TreePath.class);
